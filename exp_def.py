...
ranges = {
    "batch_glc": (0, 300, 45, "starting glucose conc. in batch media"),
    "batch_gln": (0, 50, 5, "starting glutamine conc. in batch media"),
    "batch_pH": (6.7, 7.4, 7.0, "controlled pH value"),
    "feed_glc": (50, 300, 50, "glucose conc. in feed"),
    "feed_gln": (0, 50, 0, "glutamine conc. in feed"),
    "prod_start_eft": (24, 72, 48, "time (hrs) marking shift from batch to production"),
    "batch_temp": (33, 40, 37, "T of batch phase"),
    "prod_temp": (33, 40, 37, "T of production phase"),
    "day_0_feed": (0, 50.0, 0.0, "feed in mL/day"),
    "day_1_feed": (0, 50.0, 10.0, "feed in mL/day"),
    "day_2_feed": (0, 50.0, 20.0, "feed in mL/day"),
    "day_3_feed": (0, 50.0, 35.0, "feed in mL/day"),
    "day_4_feed": (0, 50.0, 35.0, "feed in mL/day"),
    "day_5_feed": (0, 50.0, 35.0, "feed in mL/day"),
    "day_6_feed": (0, 50.0, 35.0, "feed in mL/day"),
    "day_7_feed": (0, 50.0, 35.0, "feed in mL/day"),
    "day_8_feed": (0, 50.0, 35.0, "feed in mL/day"),
    "day_9_feed": (0, 50.0, 35.0, "feed in mL/day"),
}
